...
export interface ApiGuestGuest extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    askPartnerAttendance: Schema.Attribute.Boolean &
      Schema.Attribute.DefaultTo<false>;
    confirmAttendingSoloBody: Schema.Attribute.Text;
    confirmAttendingSoloTitle: Schema.Attribute.String;
    confirmAttendingWithPartnerBody: Schema.Attribute.Text;
    confirmAttendingWithPartnerTitle: Schema.Attribute.String;
    confirmDecliningBody: Schema.Attribute.Text;
    confirmDecliningTitle: Schema.Attribute.String;
    ...
    name1: Schema.Attribute.String & Schema.Attribute.Required;
    name2: Schema.Attribute.String;
    partnerAttending: Schema.Attribute.Boolean &
      Schema.Attribute.SetPluginOptions<{
        'content-manager': {
          visible: false;
        };
...
export interface ApiSectionSection extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    blocks: Schema.Attribute.DynamicZone<
      ['blocks.text-block', 'blocks.image-block', 'blocks.button-block']
    > &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
